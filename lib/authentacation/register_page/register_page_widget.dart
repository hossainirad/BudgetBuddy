...
class _RegisterPageWidgetState extends State<RegisterPageWidget> {
  ...
  void initState() {
    ...
    _model.passwordFieldTextController ??=
        TextEditingController(text: 'a70r64L!Ali');
    _model.passwordFieldFocusNode ??= FocusNode();

    _model.cinfirmPasswordFieldTextController ??=
        TextEditingController(text: 'a70r64L!Ali');
    _model.cinfirmPasswordFieldFocusNode ??= FocusNode();
  }
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'اگر قبلا حسابی ساخته اید ورود کنید',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily:
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 0.0),
                    child: TextFormField(
                      controller: _model.cinfirmPasswordFieldTextController,
                      focusNode: _model.cinfirmPasswordFieldFocusNode,
                      autofocus: false,
                      obscureText: !_model.cinfirmPasswordFieldVisibility,
                      decoration: InputDecoration(
                        labelStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  fontFamily: FlutterFlowTheme.of(context)
                        ...
                        suffixIcon: InkWell(
                          onTap: () => setState(
                            () => _model.cinfirmPasswordFieldVisibility =
                                !_model.cinfirmPasswordFieldVisibility,
                          ),
                          focusNode: FocusNode(skipTraversal: true),
                          child: Icon(
